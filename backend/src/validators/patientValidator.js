...
export const PATIENT_STATUSES = ['active', 'inactive', 'deceased', 'merged'];
...
export const mergePatientsSchema = z.object({
  /** The chart that will be absorbed and closed. */
  sourceId: objectId,
  reason: z.string().trim().min(10, 'Give a merge reason of at least 10 characters').max(1000),
});
