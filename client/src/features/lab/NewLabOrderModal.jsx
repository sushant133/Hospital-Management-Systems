...
import { labApi, LAB_PRIORITY_OPTIONS } from './labApi.js';
 ...
 *
 * A lab order must hang off an open encounter (ARCHITECTURE.md §3), so the
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        if (!isDoctor) requests.push(api.get('/users', { params: { role: 'doctor', limit: 100 } }));
