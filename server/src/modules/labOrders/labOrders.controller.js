...
import { createCharges, cancelChargesForSource } from '../../services/billing.service.js';
import { buildResultValues } from '../../services/labResult.service.js';
import { generateLabReport, resolveUploadPath } from '../../services/labReport.service.js';
...
export const submitResult = asyncHandler(async (req, res) => {
  ...
  // Reference ranges are snapshotted here — see services/labResult.service.js.
